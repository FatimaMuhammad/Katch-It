...
import com.example.katche_it.activities.utils.ColorPicker
import com.example.katche_it.activities.utils.IconPicker
...
class QuizAdapter(val context: Context, val quizzes: List<Quiz>) :
    ...
    inner class QuizViewHolder(val binding: View) : RecyclerView.ViewHolder(binding.rootView) {
